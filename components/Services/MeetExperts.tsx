                    ...
                    >
                        <div className="flex items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6 flex-wrap sm:flex-nowrap">
                            ...
                            <Link
                                href={'/our-team'}
                            >
                                <button className="group px-8 py-3 sm:px-10 sm:py-3.5 md:px-12 md:py-4 lg:px-16 lg:py-5 border-2 border-black rounded-full flex items-center justify-center hover:bg-primary hover:border-white active:scale-95 transition-all duration-300 shrink-0 touch-manipulation">
