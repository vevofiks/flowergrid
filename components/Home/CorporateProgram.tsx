      ...
      <div className="w-full max-w-7xl h-full max-h-[90vh] grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
        ...
        <div className="flex flex-col justify-center h-full order-2 lg:order-0">
            ...
            <div className="mt-6 lg:mt-10 flex justify-end">
                <Link href="/workshops" className="group flex items-center gap-3 px-6 py-2 md:px-8 md:py-3 rounded-full border border-[#D6CFC2]/30 text-[#F3EAD8] text-xs md:text-sm uppercase tracking-widest hover:bg-[#F3EAD8] hover:text-[#4E351A] transition-all duration-300">
