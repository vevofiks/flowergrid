...
export default function BlogPostHero({
    ...
    return (
        <div className="w-full mb-16">
            {/* Hero Banner */}
            <div className="relative w-full h-[60vh] min-h-[400px] md:h-[70vh] overflow-hidden mb-12 group">
                {/* Background Image */}
                {coverImage ? (
                    <Image
                        src={coverImage}
                ...
                <div className="absolute inset-0 flex flex-col justify-end pb-12 md:pb-20">
                    <div className="max-w-[1400px] mx-auto px-6 md:px-12 w-full text-white">
            ...
            {tldr && (
                <div className="max-w-4xl mx-auto -mt-24 md:-mt-32 relative z-10 px-6">
                    <div className="bg-[#FAF6F0]/95 backdrop-blur-xl border border-[#8C7A65]/10 rounded-[2rem] p-8 md:p-12 shadow-xl shadow-[#8C7A65]/5">
