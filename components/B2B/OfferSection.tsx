...
export default function OfferSection() {
  ...
  return (
    <section className="relative w-full h-[140vh] md:h-[110vh] bg-[#4E351A] px-4 py-8 md:px-10 lg:px-20 overflow-hidden">
      <div className="flex flex-col items-center justify-center text-center mb-8 md:mb-12">
        <h1 className="text-white! text-4xl font-heading font-normal tracking-wide">What We Offer</h1>
