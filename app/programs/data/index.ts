...
export const myPrograms: ProgramData[] = [
    {
        ...
        description: "Dive deep into a complete mind-body-spirit transformation. Our expert-led 5-day program combines assessments, personalised planning, and ongoing support to create measurable, lasting change, giving you clarity, balance, and the tools to thrive both online or onsite.",
        ...
        imageUrl: `/program/p2.jpg`,
        imageAlt: "Description for accessibility",
        decorativeImages: [
            {
                src: `${imgurl}program/decorations/flower1.png`,
                alt: "Decorative element",
                position: "top-left", // top-left, top-right, bottom-left, bottom-right
                className: "rotate-45" // optional Tailwind classes
            },
            {
                src: `${imgurl}program/decorations/flower2.png`,
                alt: "Decorative element",
    ...
    },
    {
        ...
        buttonLink: "/your-link", // optional
        imageUrl: `/program/p3.jpg`,
        imageAlt: "power hour session",
        decorativeImages: [
            {
                src: `${imgurl}program/decorations/flower3.png`,
                alt: "Decorative element",
                position: "top-left", // top-left, top-right, bottom-left, bottom-right
                className: "rotate-45" // optional Tailwind classes
            },
            {
                src: `${imgurl}program/decorations/pot.png`,
                alt: "Decorative element",
                position: "bottom-right", // top-left, top-right, bottom-left, bottom-right
                className: "rotate-45" // optional Tailwind classes
            }
    ...
    },
    {
        ...
        imageUrl: `/program/p4.jpg`,
        imageAlt: "1-day workshop",
        decorativeImages: [
            {
                src: `${imgurl}program/decorations/flower4.png`,
                alt: "Decorative element",
                position: "top-left", // top-left, top-right, bottom-left, bottom-right
                className: "rotate-45" // optional Tailwind classes
            },
            {
                src: `${imgurl}program/decorations/flower5.png`,
                alt: "Decorative element",
                position: "bottom-right", // top-left, top-right, bottom-left, bottom-right
                className: "rotate-45" // optional Tailwind classes
            }
    ...
    },
    {
        ...
        description: "Experience deep, lasting transformation with personalised coaching. Our 6- and 12-week programs combine life coaching, reflective exercises, and integrated support to help you build new habits, align mind, body, and spirit, and achieve meaningful, measurable change.",
        ...
        buttonLink: "/your-link",
        imageUrl: `/program/p5.jpg`,
        imageAlt: "Tailored coaching program",
        decorativeImages: [
            {
                src: `${imgurl}program/decorations/flower7.png`,
                alt: "Decorative element",
                position: "top-left", // top-left, top-right, bottom-left, bottom-right
                className: "rotate-45" // optional Tailwind classes
            },
            {
                src: `${imgurl}program/decorations/flower6.png`,
                alt: "Decorative element",
                position: "bottom-right", // top-left, top-right, bottom-left, bottom-right
                className: "rotate-45" // optional Tailwind classes
            }
    ...
    },
    {
        ...
        imageUrl: `/program/p6.jpg`,
        imageAlt: "Corporate & Community Programs",
        decorativeImages: [
            {
                src: `${imgurl}program/decorations/flower8.png`,
                alt: "Decorative element",
                position: "top-left",
                className: "rotate-45"
            },
            {
                src: `${imgurl}program/decorations/flower9.png`,
                alt: "Decorative element",
