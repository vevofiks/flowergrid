...
const FadeInText = () => {
    ...
    return (
        <div className='h-screen w-full relative bg-[#F3EAD8] overflow-hidden z-10' ref={containerRef}>
            ...
            >
                <h2 className='line-1 mt-5 md:mt-2'>Tailored workshops on </h2>
                <h2 className='line-1 mt-5 md:mt-2'>leadership, </h2>
                <h2 className='line-1 mt-5 md:mt-2'>communication, </h2>
                <h2 className='line-1 mt-5 md:mt-2'>wellbeing, and mental</h2>
                <h2 className='line-1 mt-5 md:mt-2'>health,</h2>
            </div>
            ...
            >
                <h2 className='line-2 mt-5 md:mt-2'>designed to enhance</h2>
                <h2 className='line-2 mt-5 md:mt-2'>productivity, resilience,</h2>
                <h2 className='line-2 mt-5 md:mt-2'>and engagement</h2>
                <h2 className='line-2 mt-5 md:mt-2'>across your</h2>
                <h2 className='line-2 mt-5 md:mt-2'>organisation or</h2>
                <h2 className='line-2 mt-5 md:mt-2'>institution.</h2>
            </div>
        </div>
    );
};
