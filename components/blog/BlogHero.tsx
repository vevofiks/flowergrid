    ...
    return (
        <div className="relative w-full h-[50vh] min-h-[400px] md:h-[60vh] overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center">
                <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 w-full text-white">
                    <div className="max-w-2xl">
                        <h1 className="text-5xl md:text-7xl font-sans font-light mb-6 tracking-wide">Blogs</h1>
